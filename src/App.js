...
import MessageHod from "./components/Home/MessageHod";
import Home from "./components/Home/Home";
import FacultyAll from "./components/Home/FacultyAll";
import Vision from "./components/Home/Vision";
import Academics from "./components/Home/Academics";
import Student from "./components/Home/Student";
import Peo from "./components/Home/Vision/PEO";
import Coeighteen from "./components/Home/Vision/CoR18";
import Techastra from "./components/Home/Student/Techastra";
import Nitgrty from "./components/Home/Student/Nitgrty";
import Digital from "./components/Home/Student/Digital";
import Intern from "./components/Home/Student/Intern";
import MiniProject from "./components/Home/Academics/MiniProject";
import Timetable from "./components/Home/Academics/Timetable";
...
const App = () => {
	return (
		<Routes>
			...
			<Route exact path="/messagefromhod" element={<MessageHod />} />
			<Route exact path="/faculty" element={<FacultyAll />} />
			<Route exact path="/vision" element={<Vision />} />
			<Route exact path="/academics" element={<Academics />} />
			<Route exact path="/student" element={<Student />} />
			<Route exact path="/vision/peo" element={<Peo />} />
			<Route exact path="/student/tech" element={<Techastra />} />
			<Route exact path="/student/nit" element={<Nitgrty />} />
			<Route exact path="/student/dig" element={<Digital />} />
			<Route exact path="/student/intern" element={<Intern />} />
			<Route exact path="/academics/mini" element={<MiniProject />} />
			<Route exact path="/academics/time" element={<Timetable />} />
			{/* <Route exact path="/vision/co18" element={<Coeighteen />} /> */}
			{/* Admin  */}
